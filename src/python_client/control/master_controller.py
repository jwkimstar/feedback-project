...
class MasterControllerGains:
    ...
    heading_hold_derivative_gain: float = 0.0
...
class MasterControllerControllerTypes:
    ...
    heading_hold: HeadingControllerType = "p"
    ...
    def __init__(
        ...
        self.roll_damper = RollDamperController(
            RollDamperGains(
                ...
                min_output=(
                    ...
                    else -self.gains.roll_damper_max_yaw_rate_rad_s
                ),
                max_output=self.gains.roll_damper_max_yaw_rate_rad_s,
            )
        )
        self.heading_hold = HeadingHoldController(
            HeadingHoldGains(
                ...
                derivative_gain=self.gains.heading_hold_derivative_gain,
            )
        )
